...
Config = {
	...
	Products = {
		...
		["hardware"] = {
			...
			{ name = "repairkit", price = 250, amount = 50, info = {}, },
		...
		["vending"] = {
			...
			{ name = "kurkakola", price = 4, amount = 25, },
			{ name = "sprunk", price = 4, amount = 25, },
			{ name = "sprunklight", price = 4, amount = 25, },
			{ name = "ecola", price = 4, amount = 25, },
			{ name = "ecolalight", price = 4, amount = 25, },
			{ name = "twerks_candy", price = 4, amount = 25, },
			{ name = "snikkel_candy", price = 4, amount = 25, },
		},
		["blackmarket"] = {
